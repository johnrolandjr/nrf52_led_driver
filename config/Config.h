...
class Conf
{
	...
	public:
		...
		u16 meshConnectionSupervisionTimeout = MSEC_TO_UNITS(2000, UNIT_10_MS);   	//(100-32000) Connection supervisory timeout
		...
		u16 meshScanIntervalHigh = MSEC_TO_UNITS(150, UNIT_0_625_MS);	//(20-1024) Determines scan interval in units of 0.625 millisecond.
		u16 meshScanWindowHigh = MSEC_TO_UNITS(40, UNIT_0_625_MS);	//(2.5-1024) Determines scan window in units of 0.625 millisecond.

		//DISCOVERY_LOW
		u16 meshAdvertisingIntervalLow = MSEC_TO_UNITS(200, UNIT_0_625_MS);	//(20-1024) (100-1024 for non connectable advertising!) Determines advertising interval in units of 0.625 millisecond.
		u16 meshScanIntervalLow = MSEC_TO_UNITS(1300, UNIT_0_625_MS);	//(20-1024) Determines scan interval in units of 0.625 millisecond.
		...
		const u8 meshMaxOutConnections = 2;
...
#define PACKET_SEND_BUFFER_SIZE 1500
...
#define MAX_MODULE_COUNT 1

//Number of connections that the mesh can use
#define MAXIMUM_OUT_CONNECTIONS 2
#define MAXIMUM_CONNECTIONS (1 + MAXIMUM_OUT_CONNECTIONS)
...
enum moduleID{
	...
	SQRL_MODULE_ID=30028,
	DENTIST_MODULE_ID=30030,
	LED_MODULE_ID=30032
};
