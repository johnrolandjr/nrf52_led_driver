...
public:
	...
	static u32 bleNotifyCharacteristic(u16 connectionHandle, u16 characteristicHandle, u8* data, u16 dataLength, bool reliable);


	//Returns the handle that is used to write to the mesh characteristic
	u16 getMeshConnectionHandle();
	static u16 getMeshWriteHandle();
	static u16 getMeshWriteDescriptorHandle();
